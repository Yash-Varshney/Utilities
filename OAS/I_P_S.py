...
url_guest = "http://oas.iitmandi.ac.in/InstituteProcess/GuestHouse/GuestHouseRequest.aspx"
url_seatbooking = "http://oas.iitmandi.ac.in/InstituteProcess/Facility/BusSeatReservation.aspx"
url_passengerinfo = "http://oas.iitmandi.ac.in/InstituteProcess/Facility/PassengerMain.aspx"
...
def loginpage():
    ...
    L_IPS = Label(root, text = "Institute process solution", bg = lightblue, fg = darkblue, font=head_font)
